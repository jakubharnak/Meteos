# Source: https://randomnerdtutorials.com/micropython-mqtt-publish-bme680-esp32-esp8266/
# Update from original: 2021-12-22
...
class Adafruit_BME680:
  ...
  def altitude(self):
    ...
    return 44330 * (1.0 - (pressure / self.sea_level_pressure) ** 0.1903)
  @property
  def gas(self):
    self._perform_reading()
    ...
    if self._chip_variant == 0x01:
        ...
        var2 = (self._adc_gas - 512) * 3 + 4096
        calc_gas_res = (1000 * var1) / var2 * 100
    else:
        var1 = ((1340 + (5 * self._sw_err)) * (_LOOKUP_TABLE_1[self._gas_range])) / 65536
        var2 = ((self._adc_gas * 32768) - 16777216) + var1
        var3 = (_LOOKUP_TABLE_2[self._gas_range] * var1) / 512
  ...
  def _perform_reading(self):
    ...
    if self._chip_variant == 0x01:
        self._adc_gas = int(unpack(">H", bytes(data[15:17]))[0] / 64)
